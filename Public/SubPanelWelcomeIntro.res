"Public/SubPanelWelcomeIntro.res"
{
	...
	layout
	{
		place { control="CreateAccountButton" height=20 width=max y=256 margin-left=70 margin-right=70}
		place { control="LoginButton" height=20 width=max y=286 margin-left=70 margin-right=70 }
	}
