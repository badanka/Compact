"Servers/DialogGameInfo_NonSteam.res"
{
	...
	layout
	{
		...
		//left
		place { region=left control=GameLabel,Label3 y=18 align=right spacing=2 height=19 dir=down }
		
		//right
		place { region=right control=GameText,Label2 y=18 width=max spacing=2 height=19 dir=down }
