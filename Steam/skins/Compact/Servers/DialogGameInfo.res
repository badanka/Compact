"Servers\DialogGameInfo.res"
{
	...
	layout
	{
		...
		region { name=right region=top x=0 y=30 margin-right=10 width=311 align=right }
		...
		place { region=container control="PlayerList" x=0 y=0 width=max height=max dir=down }
		place { region=container start=PlayerList control="InfoLabel" width=max height=20 y=0 x=8 dir=down }
		place { region=container start=InfoLabel control="AutoRetryAlert,AutoRetryJoin" width=max height=20 x=8 y=0 dir=down }
