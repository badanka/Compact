"servers/InternetGamesPage.res"
{
	...
	layout
	{
		place { control="gamelist" margin-top=2 margin-bottom=24 margin-left=1 margin-right=1 height=max width=max }
		//place { control="InternetGames" margin-top=2 margin-bottom=22 height=max width=max }
