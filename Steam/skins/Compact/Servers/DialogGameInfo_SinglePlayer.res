"Servers/DialogGameInfo_SinglePlayer.res"
{
	...
	layout
	{
		...
		region { name=left region=top x=0 y=40 margin-left=10 width=85 }
		region { name=right region=top x=0 y=40 margin-right=10 width=311 align=right }

		//left
		place { region=left control=GameLabel,StatusLabel y=18 align=right spacing=2 height=19 dir=down }
		
		//right
		place { region=right control=GameText,StatusInfo y=18 width=max spacing=2 height=19 dir=down }
		
		region { name=bottom align=bottom height=24 }
		place {	control="Close" region=bottom align=right height=20 width=84 margin-bottom=4 margin-right=4 }		
